# Generated by Django 4.2.4 on 2023-08-17 22:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resi_img', models.ImageField(null=True, upload_to='users/', verbose_name='주민등록증 사진')),
                ('present_img', models.ImageField(null=True, upload_to='users/', verbose_name='현재 사진')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('address_si', models.CharField(default='', max_length=100, null=True)),
                ('address_gu', models.CharField(default='', max_length=100, null=True)),
                ('address_dong', models.CharField(default='', max_length=100, null=True)),

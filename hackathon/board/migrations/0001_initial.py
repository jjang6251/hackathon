    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('board_location_si', models.CharField(default='거래 희망 장소(시)를 입력해주세요', max_length=60, verbose_name='고객 위치(시)')),
                ('board_location_gu', models.CharField(default='거래 희망 장소(구)를 입력해주세요', max_length=60, verbose_name='고객 위치(구)')),
                ('board_location_dong', models.CharField(default='거래 희망 장소(동)를 입력해주세요', max_length=60, verbose_name='고객 위치(동)')),
